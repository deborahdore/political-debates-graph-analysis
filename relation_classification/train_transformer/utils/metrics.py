...
if _has_sklearn:
	...
	def acc_and_f1(preds, labels):
		...
		conf_matr_claim = confusion_matrix(labels, preds, labels=[1, 2])
		conf_matr_evi = confusion_matrix(labels, preds, labels=[3, 4])
		...
		return {  # "acc": acc,
			...
			'conf_matr_claim': conf_matr_claim,
			'conf_matr_evi'  : conf_matr_evi  # "acc_and_f1": (acc + f1) / 2,
		}
