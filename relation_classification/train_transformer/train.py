...
from train_transformer.utils.models import BertForSequenceTagging
from train_transformer.utils.tokenizer import ExtendedBertTokenizer
...
def evaluate(args, model, tokenizer, prefix=""):
	...
	for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
		...
		eval_file_name = str(args.model_name_or_path) + "_" + str(args.max_seq_length) + "_" + str(
			args.per_gpu_train_batch_size) + "_" + str(
			args.learning_rate) + "_" + str(args.num_train_epochs) + "_eval_results.txt"

		output_eval_file = os.path.join(eval_output_dir, prefix, eval_file_name)
